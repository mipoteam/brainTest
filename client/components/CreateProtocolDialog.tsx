...
export function CreateProtocolDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        {/* Custom Header */}
        <div className="flex items-center justify-between bg-[#005487] px-8 py-4 h-[72px]">
        ...
        <div className="flex flex-col px-16 py-4 gap-4 max-h-[calc(100vh-200px)] overflow-y-auto">
          ...
          <div className="flex items-center bg-[#F9F9F9] rounded border-t-[3px] border-t-[#005487]">
            <div className="flex items-center gap-36 w-fu ll px-8 py-3">
        ...
        <div className="flex items-center justify-end gap-4 px-8 py-4 border-t border-[#E1E1E4]">
          <button
            onClick={handleCancel}
            className="h-10 px-4 flex items-center justify-center border border-[#005487] rounded-lg hover:bg-gray-50 transition-colors"
          >
